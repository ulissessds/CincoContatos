...
import com.example.main.utils.UIEducacionalPermissao;
...
public class ListaContatosActivity extends AppCompatActivity implements UIEducacionalPermissao.NoticeDialogListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void deletarContato(Contato c) {
        SharedPreferences recuperarContatos = getSharedPreferences("contatos", Activity.MODE_PRIVATE);
        ...
        for (int i = 1; i <= num; i++) {
            ...
            if (objSel.compareTo("") != 0) {
                try {
                    ...
                    // Checar se é o número que quer deletar e sair
        ...
        // Criar editor e remover do SharedPreferences
        SharedPreferences.Editor editor = recuperarContatos.edit();
        editor.remove("contato" + deleteIndex);
        editor.commit();
    ...
    // Função para deletar ou não o contato
        ...
        if (contatos != null) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (checarPermissaoPhone_SMD(contatos.get(i).getNumero()) && !holding) {
            ...
            lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                    holding = true; // Impede que a função de call também seja chamada
        ...
        switch (requestCode) {
            case 2222:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(this, "Fazendo chamada...", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(this, "Facilite sua vida...", Toast.LENGTH_LONG).show();
